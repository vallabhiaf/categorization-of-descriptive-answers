...
for each_users_answers in all_answers.each():
    ...
    result1 = givVal(model_answer1, keywords1, answer, out_of1)
    result2 = givVal(model_answer4, keywords4, answer, out_of4)
    result3 = givVal(model_answer5, keywords5, answer, out_of5)
    result=max(result1,result2,result3)
    print("Marks1 : " + str(result)+ " out of 4")
    if(2.5<= result <=5.0):
       print("this is a good answer")
    if(1.5<=result<=2.4):
       print("this is a average answer")
    if(0<=result <=1.4):
       print("this is a bad answer,prepare well")
    ...
    print("Marks2 : " + str(result)+ " out of 4")
    if (2.5<= result <=5.0):
       print("this is a good answer")
    if (1.5<=result<=2.4):
       print("this is a average answer")
    ...
    print("Marks3 : " + str(result)+ " out of 4")
    if (2.5<=result <=5.0):
       print("this is a good answer")
    if (1.5<=result<=2.4):
       print("this is a average answer")
